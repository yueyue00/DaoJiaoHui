...
public class AlbumViewPager extends ViewPager implements MatrixImageView.OnMovingListener {
	...
	public AlbumViewPager(Context context, AttributeSet attrs) {
		super(context, attrs);
		localOptions = new DisplayImageOptions.Builder().cacheInMemory(true).cacheOnDisk(false).bitmapConfig(Bitmap.Config.RGB_565)
				.imageScaleType(ImageScaleType.EXACTLY).displayer(new SimpleBitmapDisplayer()).build();
		// DisplayImageOptions.getDefaltOpitions(0,
		// R.drawable.dangkr_no_picture,
