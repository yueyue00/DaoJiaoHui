...
public class PullableScrollView extends ScrollView implements Pullable, View.OnTouchListener {
	...
	private onScrollChangeLisenter onChangeLisenter;
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			distanceY = (int) ((event.getY() - mFirstPosition) * 0.6); // 滚动距离乘以一个系数
	...
	public void setZoom(float s) {
		...
		FragmentMain.ChangeLoading(s / (float) 300);
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		if (onChangeLisenter != null) {
			onChangeLisenter.changeAlphe(t);
		}
	}

	public void setOnScrollChangeLisenter(onScrollChangeLisenter lisenter) {
		this.onChangeLisenter = lisenter;
	}

	public void setOnRefreshLisenter(onRefreshLisenter lisenter) {
		this.onRefreshLisenter = lisenter;
	}

	public interface onScrollChangeLisenter {
		void changeAlphe(int value);
	}
