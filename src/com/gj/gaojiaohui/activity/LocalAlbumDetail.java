...
import com.gj.gaojiaohui.view.AlbumViewPager.LocalViewPagerAdapter;
import com.gj.gaojiaohui.view.LocalImageHelper;
import com.gj.gaojiaohui.view.MatrixImageView.OnSingleTapListener;
 ...
 * @date 2015-4-11
 */
public class LocalAlbumDetail extends GaoJiaoHuiBaseActivity implements OnSingleTapListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
	...
	public class MyAdapter extends BaseAdapter {
		...
		public MyAdapter(Context context, List<LocalImageHelper.LocalFile> paths) {
			...
			options = new DisplayImageOptions.Builder().cacheInMemory(true).cacheOnDisk(false).showImageForEmptyUri(R.drawable.zsxq_img_default_nor)
					.showImageOnFail(R.drawable.zsxq_img_default_nor).showImageOnLoading(R.drawable.zsxq_img_default_nor)
					.bitmapConfig(Bitmap.Config.RGB_565).setImageSize(new ImageSize(((MyApplication) context.getApplicationContext()).getQuarterWidth(), 0))
		...
		public View getView(final int i, View convertView, ViewGroup viewGroup) {
			...
			// imageView, options);
			ImageLoader.getInstance().displayImage(localFile.getThumbnailUri(), new ImageViewAware(viewHolder.imageView), options, loadingListener, null,
					localFile.getOrientation());
