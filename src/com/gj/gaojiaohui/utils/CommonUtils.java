...
import com.gj.gaojiaohui.qrcode.utils.EncodingUtils;
...
public class CommonUtils {
	...
	public static void saveTel(Context context, String name, String email, String mobile, String phone) {
		...
		// email
		it.putExtra(android.provider.ContactsContract.Intents.Insert.EMAIL, email);
		// 手机号码
		it.putExtra(android.provider.ContactsContract.Intents.Insert.PHONE, mobile);
		// 住宅电话
		it.putExtra(android.provider.ContactsContract.Intents.Insert.TERTIARY_PHONE, phone);
	...
	public static void hideKeyboard(Activity activity) {
		if (activity != null) {
			...
			if (imm.isActive()) {
				...
				// InputMethodManager.HIDE_NOT_ALWAYS);//这个据说很好使
			}
		}
	}
	 ...
	 *            true开启 false为关闭
	 */
	public static void switchKeyboard(View v, Boolean mode, EditText mEtSearch) {
	...
	static InputFilter stringFilter = new InputFilter() {
		...
		Pattern string = Pattern.compile("[\ud83c\udc00-\ud83c\udfff]|[\ud83d\udc00-\ud83d\udfff]|[\u2600-\u27ff]|[/<>^]", Pattern.UNICODE_CASE
				| Pattern.CASE_INSENSITIVE);
	...
	public static Bitmap createQRcode(String value) {
		...
		Bitmap qrCodeBitmap = EncodingUtils.createQRCode(value, 500, 500, null);
		return qrCodeBitmap;
	}
