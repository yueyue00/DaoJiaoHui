...
public class MyZhanPinAdapter extends BaseAdapter {
	...
	List<ExhibitorsDetailsChildBean> list;

	public MyZhanPinAdapter(Context context, List<ExhibitorsDetailsChildBean> list) {
