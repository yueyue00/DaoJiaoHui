 ...
 * 我的关注列表的适配器
 */
public class FollowListAdapter extends CommonAdapter<FollowBean> {
	...
	public FollowListAdapter(Context context, List<FollowBean> datas, int itemLayoutResId) {
	...
	private void addListener(ViewHolder viewHolder, final int position) {
		...
		imageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO 这部分做取消关注的操作
				changeListener.OnRefresh(getItem(position).id);
			}
		});
	}
